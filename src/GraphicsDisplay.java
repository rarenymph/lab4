...
// Отобразить график
    ...
    protected void paintMarkers(Graphics2D canvas) {
        // Шаг 1 - Установить специальное перо для черчения маркеров
        canvas.setStroke(markerStroke);
        // Выбрать красный цвет для маркеров


        // Шаг 2 - Организовать цикл по всем точкам графика
        for (Double[] point : graphicsData) {
            // Получить центр маркера (x, y)
            Point2D.Double center = xyToPoint(point[0], point[1]);

            // Длина основного креста и дополнительных палочек
            int crossSize = 6;  // Размер креста
            int stickSize = 2;  // Длина палочек на концах
            ...
            // Дополнительные палочки на концах горизонтальной линии
            canvas.draw(new Line2D.Double(
            ...
            // Дополнительные палочки на концах вертикальной линии
            canvas.draw(new Line2D.Double(
            ...
            if((int)sqrt((int)center.getY()) == sqrt((int)(center.getY()))){
                System.out.println(sqrt(center.getY()));
    ...
    private void drawZero(Graphics2D canvas) {
        // Добавление нуля на пересечении осей
        Point2D.Double zeroPos = xyToPoint(0, 0);
        canvas.drawString("0", (float) zeroPos.getX() - 10, (float) zeroPos.getY() + 10);
    }
    ...
    protected void paintAxis(Graphics2D canvas) {
        ...
        if (minY <= 0.0 && maxY >= 0.0) {
            // Сама ось - это линия между точками (minX, 0) и (maxX, 0)
            ...
            // Вести нижнюю часть стрелки в точку с относительными координатами (0, 10)
        ...
        // Вызов метода для рисования нуля
        drawZero(canvas);
    }
